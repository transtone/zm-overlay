...
# git archive -v --prefix=aufs-util-3.8_p20130401/ --remote=git://aufs.git.sourceforge.net/gitroot/aufs/aufs-util.git aufs3.0 -o aufs-util-3.8_p20130401.tar && xz -ve9 *.tar
