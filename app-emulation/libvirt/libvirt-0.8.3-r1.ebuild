...
src_prepare() {
	...
	epatch ${FILESDIR}/01-qxl-xml.patch
	epatch ${FILESDIR}/02-spice-graphics.patch
	#epatch ${FILESDIR}/03-fix-conf.patch
	epatch ${FILESDIR}/04-imp-qxl-drv.patch
	epatch ${FILESDIR}/05-implement-spice-graphics.patch
	epatch ${FILESDIR}/06-auto-port-spice.patch
	epatch ${FILESDIR}/07-spice-conf.patch
	epatch ${FILESDIR}/08-password-expire.patch
	epatch ${FILESDIR}/09-multi-qxl.patch
	epatch ${FILESDIR}/10-spice-security.patch
