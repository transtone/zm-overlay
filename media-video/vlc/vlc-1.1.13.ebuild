...
RDEPEND="
		...
		nsplugin? ( x11-libs/libXpm x11-libs/libXt x11-libs/libxcb x11-libs/xcb-util )
...
DEPEND="${RDEPEND}
	...
	nsplugin? ( ~net-libs/npapi-sdk-0.27 )
	dev-util/pkgconfig"
...
src_configure() {
	...
	if use nsplugin; then
		MOZILLA_CFLAGS=$(pkg-config --cflags npapi-sdk = 0.27);
		export MOZILLA_CFLAGS;
	fi
