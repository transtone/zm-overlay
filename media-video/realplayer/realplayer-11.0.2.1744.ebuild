...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/media-video/realplayer/Attic/realplayer-11.0.1.1056-r2.ebuild,v 1.1 2008/10/29 17:32:24 beandog Exp $
...
pkg_nofetch() {
	...
	einfo ${HOMEPAGE}
	einfo ""
	einfo "Choose Linux/x86 Releases: RealPlayer 11 Gold: RPM"
	einfo "http://forms.real.com/real/player/download.html?f=unix/RealPlayer11GOLD.rpm"
	einfo ""
